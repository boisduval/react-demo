...
class SecurityView extends React.Component {
  ...
  getChart() {
    ...
    myChart1.setOption({
      ...
      legend: {
        data: [
          this.state.forYear.series[0].name,
          this.state.forYear.series[1].name,
        ],
        itemWidth: 8,
        textStyle: {
          color: "#46a6b5",
    ...
    myChart2.setOption({
      ...
      legend: {
        data: [
          this.state.abnormal.series[0].name,
          this.state.abnormal.series[1].name,
          this.state.abnormal.series[2].name,
        ],
        itemWidth: 8,
        textStyle: {
          color: "#46a6b5",
  ...
  render() {
    ...
    return (
      <div className="content flex-col">
        <div className="flex2">
          {/* 上 */}
          <Top styleList={styleList} dataList={this.state.topBar}></Top>
        </div>
    ...
    return (
      <div className="flex">
        <MainBorder>
          <div
            className="flex-row"
            style={{ height: "100%", padding: "2% 3%" }}
          >
            <div className="flex">
              <MainBg>{this.props.children[0]}</MainBg>
            </div>
            <div style={{ height: "100%", width: "2px" }} />
            <div className="flex">
              <MainBg>{this.props.children[1]}</MainBg>
            </div>
          </div>
        </MainBorder>
      </div>
    ...
    if (dataList.hasOwnProperty("data")) {
      return (
        <TopBorder>
          <div
            className="flex-row"
            style={{ height: "100%", padding: "1.5% 2%" }}
          >
